    ...
    return (
        <div className="grow flex flex-col items-center justify-center h-full">
            ...
            <div className="m-4">
                ...
                <p className="text-center mb-2">You chose: {capitalize(props.languageChosen)}</p>
                <p className="text-center mb-2">The correct language was: {capitalize(props.languageActual)}</p>
