    ...
    return (
        <div className="grow flex flex-col items-center justify-center h-full">
            ...
            <div className="flex items-center justify-between">
                <input className="m-2 p-2 rounded-md" type="text" value={shareUrl} readOnly />
                <button className={isCopied ? buttonStyleCopied : buttonStyle} onClick={copyToClipboard}>📋</button>
            </div>
        </div>
    )
}